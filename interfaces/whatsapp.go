...
type WhatsappRepository interface {
	...
	GetUrlMedia(ctx context.Context, mediaID string, accessToken string) (string, error)
	DownloadMedia(ctx context.Context, url, accessToken string, name string) (string, error)
